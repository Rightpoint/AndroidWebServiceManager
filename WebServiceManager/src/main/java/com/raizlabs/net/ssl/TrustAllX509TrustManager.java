...
/**
 * {@link com.raizlabs.net.ssl.TrustManager} which accepts all certificates
 * and hosts.
 * @author Dylan James
 */
public class TrustAllX509TrustManager implements com.raizlabs.net.ssl.TrustManager  {
